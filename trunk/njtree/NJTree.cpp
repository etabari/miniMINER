 ...
 *
 * This file has been modified by Ehsan Tabari to create debug information
 */
#ifdef HAVE_CONFIG_H
    #include "config.h"
#endif
 ...
 * @param tree 
 */
void NJTree::generateTree(clustalw::PhyloTree* phyTree, clustalw::DistMatrix* distMat, clustalw::SeqInfo* seqInfo,
                                  ofstream* tree)
{
    if (tree == NULL)
    {
    ...
    if (fnseqs == 2)
    {
        if (verbose)
        {
            (*tree) << "Cycle   1     =  SEQ:   1 (" << setw(9) << setprecision(5) 
    ...
    for (nc = 1, loop_limit = (lastSeq - firstSeq + 1-3); nc <= loop_limit; ++nc)
    {
	    ...
	    if (verbose) 
	    {
            ...
            {
                j = lpj->n;
                (*tree)  << setw(9) << setprecision(5) << sumCols[j] << " ";
            }
            ...
            {
                j = lpj->n;
                (*tree)  << setw(9) << setprecision(5) << sumRows[j] << " ";
            }
        ...
        if (verbose)
        {
            (*tree) << "\n TEST: step="<< nc << " sumd="  << setw(9) << setprecision(5) << sumd;
        }
        ...
        if (verbose)
        {
            (*tree) << "\n TEST: tmin=" << setw(9) << setprecision(5) << tmin << " mini=" << mini << " minj=" << minj 
                    << "\n TEST: av ";

            for(i = 1; i <= lastSeq - firstSeq + 1; ++i)
            {
                (*tree)  << setw(9) << setprecision(5) << av[i] << " ";
            }
        ...
        {
            (*tree) <<  "\n TEST: dio=" 
                    << setw(9) << setprecision(5) << dio 
                    << " djo="  << setw(9) << setprecision(5) << djo 
                    << " dmin=" << setw(9) << setprecision(5) << dmin 
                    << " bi="  << setw(9) << setprecision(5) << bi 
                    <<  " bj=" << setw(9) << setprecision(5) << bj 
        ...
        if (verbose)
        {
            if (typei == 0)
            {
                (*tree) <<  "Node:" << setw(4) << mini << " (" << setw(9) << setprecision(5) 
                        << bi << ") joins ";
            }
            else
            {
                (*tree) << " SEQ:" << setw(4) << mini << " (" << setw(9) << setprecision(5)
                        << bi << ") joins ";
            }

            if (typej == 0)
            {
                (*tree) << "Node:" << setw(4) << minj << " (" << setw(9) << setprecision(5)
                        << bj << ")";
            }
            else
            {
                (*tree) << " SEQ:" << setw(4) << minj << " (" << setw(9) << setprecision(5)
                        << bj << ")";
            }
    ...
    {
        (*tree) << "\n TEST: b1=" 
                << setw(9) << setprecision(5) << b1 
                << " b2=" << setw(9) << setprecision(5) << b2 
                << " b3=" << setw(9) << setprecision(5) << b3;

        (*tree) << "\n TEST: branch " 
                << setw(9) << setprecision(5) << branch[1] 
                << " " << setw(9) << setprecision(5) << branch[2] 
                << " " << setw(9) << setprecision(5) << branch[3];
